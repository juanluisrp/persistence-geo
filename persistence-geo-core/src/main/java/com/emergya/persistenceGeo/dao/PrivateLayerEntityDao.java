...
public interface PrivateLayerEntityDao extends GenericDAO<PrivateLayerEntity, Long> {
	...
	/**
	 * Get a private layer by the id private layer 
	 * 
	 * @param <code>privateLayerID</code>
	 * 
	 * @return Entity associated with the private layer identifier or null if not found 
	 */
	public PrivateLayerEntity getPrivateLayer(String privateLayerID);
	 ...
	 * 
	 */
	public void delete(String privateLayerID);
}
