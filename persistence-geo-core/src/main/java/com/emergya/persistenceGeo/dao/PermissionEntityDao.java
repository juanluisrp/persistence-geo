...
public interface PermissionEntityDao extends GenericDAO<PermissionEntity, Long> {
	...
	/**
	 * Get a permission by the id permission 
	 * 
	 * @param <code>permissionID</code>
	 * 
	 * @return Entity associated with the permission identifier or null if not found 
	 */
	public PermissionEntity getPermission(String permissionID);
